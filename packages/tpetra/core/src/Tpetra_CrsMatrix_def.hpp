...
// KDDKDD NOT SURE WHY THIS MUST RETURN A SHARED_PTR
  ...
  void
  CrsMatrix<Scalar, LocalOrdinal, GlobalOrdinal, Node>::
  transferAndFillComplete_getParameters (
    ...
    int& reduced_mismatch) const
  {
   ...
   iallreduceRequest = std::shared_ptr< ::Tpetra::Details::CommRequest>();
   mismatch = 0;
   reduced_mismatch = 0;
...
CrsMatrix<Scalar, LocalOrdinal, GlobalOrdinal, Node>::
                           ...
                           const Teuchos::RCP<Teuchos::ParameterList>& params) const
  {
    ...
    // Get the caller's parameters
    //
    bool isMM, reverseMode, restrictComm;
    int mm_optimization_core_count;
    RCP<ParameterList> matrixparams;
    bool overrideAllreduce, useKokkosPath;
    std::shared_ptr< ::Tpetra::Details::CommRequest> iallreduceRequest;
    int mismatch, reduced_mismatch;
    
    transferAndFillComplete_getParameters(rowTransfer, params, isMM, reverseMode, 
      restrictComm, mm_optimization_core_count, matrixparams, overrideAllreduce, 
